...
<template>
	...
	<div class="container mx-auto mb-8 px-4 py-4 md:mb-16 lg:mb-24">
		<h1 class="mb-6 text-3xl font-bold text-gray-800">Mottagningar</h1>
				...
				>
					<div class="mt-4 space-y-2">
						<div class="flex items-center justify-between">
							...
							<Badge :text="clinic.status" :variant="clinic.status === 'Öppet' ? 'success' : 'secondary'" />
						</div>
						<div class="flex items-center justify-between">
...
class="mt-3" />
		...
		<!-- Booking Modal -->
		<Modal title="Boka tid" v-model:visible="showBookingModal" size="medium">
			<div class="space-y-4">
