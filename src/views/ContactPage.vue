	...
	<div class="container mx-auto px-4 py-4 mb-8 md:mb-16 lg:mb-24">
		<div class="max-w-4xl mx-auto">
			...
			<p class="text-lg text-neutral-800 mb-8">
				Här hittar du kontaktinformation till vår vårdcentral. Välkommen
				att kontakta oss för frågor eller för att boka tid.
			</p>
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				<div class="bg-white rounded-lg shadow-md p-6">
					...
					<div class="space-y-3 text-neutral-700">
						...
						<p>
							<span class="font-medium">Telefon:</span> 08-123 456
							78
						</p>
						<p>
				...
				<div class="bg-white rounded-lg shadow-md p-6">
					...
					<div class="space-y-3 text-neutral-700">
						...
						<p><span class="font-medium">Nödnummer:</span> 112</p>
					</div>
				</div>
			</div>
			...
			<div class="bg-white rounded-lg shadow-md p-6 mt-6">
				...
				<p class="text-neutral-700 mb-4">
					Fyll i formuläret nedan så kontaktar vi dig. Observera att
					detta formulär inte är för akuta ärenden.
				</p>
				...
				<form class="space-y-4">
					<div>
						...
						<input
							type="text"
							id="name"
							class="w-full px-3 py-2 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
			...
			<div class="bg-white rounded-lg shadow-md p-6 mt-6">
				...
				<p class="text-neutral-700 mb-4">
					Vår vårdcentral ligger centralt i Stockholm med goda
					kommunikationer.
				</p>
				<div
