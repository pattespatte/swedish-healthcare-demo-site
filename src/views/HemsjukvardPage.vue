...
const homeCareServices = [
	...
	},
	{
		...
		description:
			"Hjälp med personlig hygien, måltider och andra grundläggande behov",
		category: "Omsorg",
		duration: "Efter behov",
	...
	},
	{
		...
		description:
			"Läkare gör hembesök för medicinska bedömningar och behandling",
	...
	},
	{
		...
		description:
			"Utlåning och anpassning av hjälpmedel för att underlätta vardagen",
		category: "Hjälpmedel",
		duration: "Efter behov",
...
const eligibilityCriteria = [
	{
		...
		description:
			"Du har medicinska behov som kräver professionell vård i hemmet",
		icon: "medical",
	},
	{
		title: "Svårt att ta sig till mottagning",
		description:
			"Din hälsa gör det svårt eller omöjligt att besöka vårdcentralen",
		icon: "mobility",
	},
	{
		title: "Läkarintyg",
		description:
			"Du behöver ett läkarintyg som styrker ditt behov av hemsjukvård",
		icon: "certificate",
	},
	{
...
<template>
	...
	<div class="container mx-auto px-4 py-4 mb-8 md:mb-16 lg:mb-24">
		<h1 class="text-3xl font-bold text-gray-800 mb-6">Hemsjukvård</h1>
		...
		>
			<p class="text-gray-600 mb-6">
				...
				ditt hem. Vi arbetar för att du ska kunna få den vård du behöver
				med bibehållen självständighet och livskvalitet.
			</p>
		...
		>
			...
			<div class="bg-gray-50 p-4 rounded-md">
				...
				<p class="text-sm text-gray-700 mb-3">
					För de flesta medicinska insatser gäller högkostnadsskyddet
					precis som vid besök på vårdcentralen. Vissa omsorgsinsatser
					kan vara avgiftsbelagda baserat på inkomst.
				</p>
				<p class="text-sm text-gray-700">
					<strong>Maxavgift:</strong> För medicinsk hemsjukvård gäller
					samma maxavgift som för övrig sjukvård, för närvarande 1 150
					kr per år.
				</p>
			</div>
		</div>
		...
		>
			...
			<div class="bg-blue-50 p-4 rounded-md">
				...
				<p class="text-sm text-blue-700 mb-3">
					För akut hemsjukvård utanför ordinarie arbetstid, ring vår
					akutmottagning på 08-123 456 80.
				</p>
		...
		<!-- Contact Modal -->
		<Modal
			title="Kontakta oss om hemsjukvård"
