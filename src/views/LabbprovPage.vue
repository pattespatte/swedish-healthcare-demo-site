...
const labTests = [
	...
	},
	{
		name: "Urinvägsprov",
		description:
			"Analys av urin för att upptäcka infektioner eller sjukdomar",
		category: "Urin",
	...
	},
	{
		name: "Cellprov",
		description:
			"Gynekologiskt cellprov för tidig upptäckt av cellförändringar",
		category: "Cellprov",
...
<template>
	...
	<div class="container mx-auto px-4 py-4 mb-8 md:mb-16 lg:mb-24">
		<h1 class="text-3xl font-bold text-gray-800 mb-6">Labbprov</h1>
		...
		>
			<p class="text-gray-600 mb-6">
				...
				provtagningstjänster. All personal är utbildad för att ta prover
		...
		<div
			...
			class="bg-white rounded-lg shadow-md p-6"
		>
			<h2 class="text-xl font-semibold mb-4">Hämta dina provsvar</h2>
			<div class="space-y-4">
				<ListItem
		...
		<!-- Booking Modal -->
		<Modal
			title="Boka tid för provtagning"
			...
			<div class="space-y-4">
				<div class="bg-blue-50 p-4 rounded-md">
					<p class="text-sm text-blue-800">
						Du bokar tid för: <strong>{{ selectedTest }}</strong>
					</p>
				</div>
