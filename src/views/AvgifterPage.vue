...
<template>
	...
	<div class="container mx-auto mb-8 px-4 py-4 md:mb-16 lg:mb-24">
		<div class="mx-auto max-w-6xl">
			<h1 class="mb-6 text-3xl font-bold text-gray-800">Avgifter</h1>
			<p class="mb-8 text-lg text-neutral-800">
				Här hittar du information om kostnader för vård och behandling. Sverige har ett högkostnadsskydd som innebär att
				du betalar högst en viss summa per år.
			</p>

			<div class="mb-8 border-l-4 border-green-500 bg-green-50 p-4">
				<div class="flex">
					...
					<div class="ml-3">
						<p class="text-sm text-green-800">
							...
							När du har nått högkostnadsskyddet får du frikort som ger fri vård under resterande del av perioden.
							Kortet skickas automatiskt till din folkbokföringsadress.
						</p>
					</div>
				</div>
			</div>
			...
			<div class="mb-8 grid grid-cols-1 gap-4 md:grid-cols-3">
				<InfoCard title="1 450 kr" content="Högkostnadsskydd för vård" variant="primary" />
				<InfoCard title="3 800 kr" content="Högkostnadsskydd för läkemedel" variant="primary" />
				<InfoCard title="2 000 kr" content="Högkostnadsskydd för resor" variant="primary" />
			</div>

			<div class="mb-6 rounded-lg bg-white p-6 shadow-md">
				<h2 class="mb-4 text-xl font-semibold">Vårdcentral - Priser</h2>
...
:paginated="false" />
			...
			<div class="mb-6 rounded-lg bg-white p-6 shadow-md">
				<h2 class="mb-4 text-xl font-semibold">Specialistvård - Priser</h2>
				<p class="mb-4 text-neutral-700">
...
:paginated="false" />
			...
			<div class="mb-6 rounded-lg bg-white p-6 shadow-md">
				<h2 class="mb-4 text-xl font-semibold">Högkostnadsskydd</h2>
				<p class="mb-4 text-neutral-700">
...
:paginated="false" />
			...
			<div class="rounded-lg bg-white p-6 shadow-md">
				<h2 class="mb-4 text-xl font-semibold">Viktigt att veta</h2>
				<ul class="list-inside list-disc space-y-2 px-4 text-neutral-700">
					<li>Barn och ungdomar under 20 år har gratis vård inom landstinget</li>
					<li>Om du har frikort, ta med det vid varje besök</li>
					<li>Vissa tjänster kan ha andra avgifter än de som anges ovan</li>
					<li>Privat vård har andra priser och omfattas inte av högkostnadsskyddet</li>
					<li>För mer information om avgifter och frikort, kontakta vår reception</li>
				</ul>
			</div>
		</div>
	</div>
