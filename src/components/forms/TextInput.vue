<template>
	<div class="mb-4">
		<label :for="id" class="mb-1 flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-primary">
			...
			<input
				...
				:class="[
					...
					error
						...
						: 'border-gray-300 focus:border-primary-500 focus:ring-primary-500 dark:border-slate-500 dark:focus:border-primary-400 dark:focus:ring-primary-400',
