		...
		<input
			...
			:class="[
				...
				error
					...
					: 'border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:border-dark-border-primary dark:focus:ring-primary-400 dark:focus:border-primary-400',
				disabled
					? 'bg-gray-100 cursor-not-allowed dark:bg-dark-bg-quaternary'
